...
public class RadioStation {
  ...
  public RadioStation(String changeuuid, String stationuuid, String serveruuid, String name, String url,
      String urlResolved, String homepage, String favicon, String tags, String country, String countrycode,
      String iso3166_2, String state, String language, String languagecodes, int votes, String lastchangetime,
      String lastchangetimeIso8601, String codec, int bitrate, int hls, int lastcheckok, String lastchecktime,
      String lastchecktimeIso8601, String lastcheckoktime, String lastcheckoktimeIso8601, String lastlocalchecktime,
      String lastlocalchecktimeIso8601, String clicktimestamp, String clicktimestampIso8601, int clickcount,
      int clicktrend, int sslError, Double geoLat, Double geoLong, boolean hasExtendedInfo) {
